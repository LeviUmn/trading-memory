...
metadata: 
  ...
  modified: 2026-08-24T12:27:25.967Z
---
...
5. TP1 = der nächste verbleibende Kandidat aus Schritt 4 (Zone 1 oder 2, nicht Zone 3), der zusätzlich **RR≥1,5:1** zu R erfüllt (verschärft von RR≥1:1 auf RR≥1,5:1, 24.08.2026 — siehe Änderungsvermerk unten; der allgemeine 8b-Baseline-Gate bleibt bei RR≥1:1 als absoluter Mindestfilter, 8b1 zieht für die eigentliche TP1-Kandidatenauswahl die Latte höher). RR ergibt sich aus der echten Distanz — schwankendes RR ist gesund und erwartbar, kein Mangel, der ausgeglichen werden müsste.
6. Erfüllt kein Kandidat innerhalb Zone 1/2 gleichzeitig RR≥1,5:1 → **kein Trade.** Explizit als "kein valides RR trotz bestätigtem Setup" loggen — nicht das ferne, unrealistische Level trotzdem als TP1 nehmen, nur weil die RR-Zahl formal passt.
