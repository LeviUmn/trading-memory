...
**Erweiterung auf Exit-Abweichungen vom Standard (05.08.2026, Fable-Tagesabschluss-Review nach Trade #32):** Dieselbe Offenlegungspflicht gilt nicht nur am Entry, sondern auch, wenn eine Exit-Entscheidung bewusst vom 8b-Standard (Teilexit bei TP1 + Rest weiter Richtung TP2) abweicht — z.B. ein kompletter Vollexit bei TP1 statt des Runners. Trade #32 (05.08.2026) wich auf User-Wunsch wegen einer als "Chop" wahrgenommenen Marktphase vom Standard ab, ohne dass die formalen Chop-Kriterien (RSI/MACD-Flip-Flop + flacher VIX, siehe [[feedback_chartanalyse]] Marktregime-Filter) zum Entscheidungsmoment explizit mit Zahlen durchgegangen wurden — die Entscheidung war vertretbar, aber nicht mit demselben Beleg-Standard dokumentiert, den das System für vergleichbare Eingriffe sonst verlangt. **How to apply:** Bei jeder Abweichung vom Standard-Exit-Ablauf (Vollexit statt Teilexit+Runner, vorzeitiger Komplettausstieg vor TP1/TP2) dieselbe Chop-Check-Pflichtzeile mit den konkreten RSI/MACD/VIX-Werten zum Entscheidungsmoment ausgeben, nicht nur am Entry.
