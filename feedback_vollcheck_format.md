...
metadata:
  ...
  modified: 2026-07-27T18:06:53.794Z
---
...
**How to apply:** Jeder Voll-Check-Output folgt diesem Muster (kompakt, kein langer Fließtext-Absatz, aber Satz-/Aufzählungsform statt Tabelle):

```
Voll-Check <Uhrzeit> — <1-Satz-Einordnung>

1H NAS100: RSI <x> ✓/✗ <bearish/bullish bestätigt>, MACD-H <x> ✓/✗, <EMA50/BB-Status> ✓/✗
