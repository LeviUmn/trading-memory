...
- [Phase 4 final definiert + Übergang ins normale Trading](project_vision.md) — 31.07., User-Entscheidung: Phase 4 (ab Trade 36) = UnusualWhales (konditional) + 10.000€/Trade, kein festes Enddatum. Danach Ende des Phasensystems, Übergang zu 50.000€ Realkapital — Vorbedingung dafür: Wochen-/Monatsabschlüsse als neue Tracking-Ebene (siehe [[project_risikomanagement]])
