...
- [Opus+Fable-Vollcheck 24.08.2026: N-1 bis N-22 abgearbeitet, D-1 bis D-5 offen für Levi](project_opus_vollpruefung_2026-08-24.md) — C-1 bis C-4 + gate_check.cjs umgesetzt, Phase-3 korrigiert (RR 1,03:1, EV −0,059%). **Finaler Nachtrag:** Alle 17 direkt umsetzbaren N-Punkte erledigt (Q-Score UNBEKANNT-Zustand statt falsch-ROT, Cluster-Gate an ATR gekoppelt, trades.sql/trades_dax.sql neu gezogen+committet, trade_stats.cjs um TP1-/TP2-Quote+exit_type erweitert, --violation-0-Bug, runway_ratio-Formel vereinheitlicht, retroaktiver Gate-Check #36-43 in DB zurückgeschrieben — 6/8 FAIL, u.a.). **5 echte Entscheidungen NICHT von Fable getroffen, nur vorbereitet (Optionen+Empfehlung im Dokument):** D-1 Zone-1-RR-Schwelle 8b1 Schritt 5 (rechnerisch unerreichbar, Fables Empfehlung: Zone 1 zurück auf 1:1-Baseline), D-2 Code-Struktur dafür bereits inert vorbereitet, D-3 Phase-Zuordnung #41-43 (Phase 3 würde bei Umklassifizierung von −57,77€/negativ auf +25,76€/positiv EV kippen), D-4 Phase-4-Gates-Zwischenstand berechnet (4/6 bereits verfehlt bei n=8, keine Dringlichkeit), D-5 Testfenster-Enderkriterium vs. Früh-Exit-Stack (Empfehlung: Enderkriterium auf TP1-Quote reduzieren statt Stack jetzt anzufassen)
